...
class TransLOB(nn.Module):
    """
    Implémentation fidèle à Wallbridge (2020) :
    – padding causal (gauche-seul) → longueur conservée (100)
    – ReLU dans le MLP
    – pas de dropout interne dans le bloc Transformer
    – poids partagés entre les ‘depth’ itérations
    """
    def __init__(self,
        *,
        seq_len: int =          100,
        ...
        # ---------- 1. CNN dilaté causal : padding gauche seul ----------
